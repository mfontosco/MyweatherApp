$(document).ready(function(){
    $("#InputValue").on("keyup",function(e){
        ...
        $.ajax({
         ...
         const weatherTemp =(weatherdata.main.temp -273).toFixed(2)
         const feelsLike = (weatherdata.main.feels_like -273).toFixed(2)
         $("#profile").html(`
         <div class="row">
         <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">The temperature at ${cityname} is = ${weatherTemp}&#8451 and it feels like ${feelsLike} &#8451</p>
